...
def run_experiment(input_len, output_len, exp_num, total_exps):
    ...
    tag = f"tp4_i{input_len}_o{output_len}"
...
def main():
    ...
    print(f"Starting tp4 sweep: {len(input_lens)} input lengths × {len(output_lens)} output lengths = {total_exps} experiments")
