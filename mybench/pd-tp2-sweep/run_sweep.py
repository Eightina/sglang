#!/usr/bin/env python3
"""Run PD tp2 sweep benchmark suite."""
...
dataset = "random-ids"
output_dir = "./mybench/pd-tp2-sweep"
...
def run_experiment(input_len, output_len, exp_num, total_exps):
    ...
    tag = f"pdtp2_i{input_len}_o{output_len}"
...
def main():
    ...
    print(f"Starting PD tp2 sweep: {len(input_lens)} input lengths × {len(output_lens)} output lengths = {total_exps} experiments")
